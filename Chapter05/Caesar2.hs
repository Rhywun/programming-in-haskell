...
-- Converts a char 'a' to 'z' or 'A' to 'Z' to an integer 0 to 25
char2int c | isLower c = ord c - ord 'a'
...
-- Shifts char c to the right by n letters; wraps at alphabet end
shift n c | isLower c = int2charLower ((char2int c + n) `mod` 26)
          | isUpper c = int2charUpper ((char2int c + n) `mod` 26)
          | otherwise = c
